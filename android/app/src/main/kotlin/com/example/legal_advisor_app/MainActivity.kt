        ...
        try {
          when (call.method) {
            "init" -> {
              ...
              mainScope.launch {
                try {
                  ...
                  if (success) {
                    android.util.Log.d("LegalAdvisor", "✅ AI组件初始化成功")
                    result.success("AI就绪")
                  } else {
              ...
              mainScope.launch {
                try {
                  val response = if (gemmaInference != null) {
                    ...
                    android.util.Log.w("LegalAdvisor", "⚠️ 模型未初始化，使用备用响应")
            ...
            "test_model" -> {
              ...
              mainScope.launch {
                try {
                  val testResult = ModelVerificationTest(this@MainActivity).runFullVerification()
